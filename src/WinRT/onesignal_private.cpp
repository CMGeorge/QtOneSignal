...
OneSignal_private::OneSignal_private(QObject *parent):
    QObject(parent)
{
    m_initDone = false;
    m_foreground = true;
...
void OneSignal_private::Init(QString appId,QVariantMap startupParams){
...
void OneSignal_private::onPushNotificationChannelReceived(IPushNotificationChannel* pnc){
...
//currentChannelUri
void OneSignal_private::sendSession(QString currentChannelUri){
...
void OneSignal_private::finished(QNetworkReply* replay){
...
void OneSignal_private::handleSSLErrors(QNetworkReply*){
    qDebug()<<"SSL error!!!!";
}
void OneSignal_private::registerForNotifications(){
